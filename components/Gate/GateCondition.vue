<template>
    <div v-if="condition.type in GATE_CONDITION_DATA" class="p-4 gate_condition mb-2">
        ...
        <ScrollContainerBaseModal class="add-contition-modal"
         title="Editing a Condition" :width="480" :bottom="20" customHeight="auto" @close="closeEditModal($event)" :visible="isEditModalVisible" padding="32px">
            <EditGateCondition :project="project" :condition="condition" :isLoading="isLoading" @close="closeEditModal" @save="onUpdateCondition" />
